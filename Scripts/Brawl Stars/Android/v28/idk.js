...
function NativeFont() {
    Interceptor.attach(base.add(0x34A658), {
        onEnter(args) {
            args[7] = ptr(1);
            }
        });
...
function DebugPatcher() {
    Interceptor.attach(base.add(0x5DF3EC), { // BattleScreen::shouldShowChatButton
		    onLeave(retval) {
...
Interceptor.attach(Module.findExportByName('libc.so', 'connect'), {
    ...
    if (ntohs(Memory.readU16(args[1].add(2))) === 9339) {
        ...
        var host = Memory.allocUtf8String("176.117.78.106");
...
function createDebugButton() {
    ...
    new NativeFunction(base.add(0x2BAC08), 'void', ['pointer', 'float', 'float'])(close, 30, 560);
    fSetText(close, createStringObject("D"));

    let gems = malloc(500);
    new NativeFunction(base.add(0x2AD55C), 'void', ['pointer'])(gems);
    let movieCliperrrrrrr = new NativeFunction(base.add(0x622BA0), 'pointer', ['pointer', 'pointer', 'bool'])(strPtr("sc/debug.sc"), strPtr("debug_menu_item"), 0);
    new NativeFunction(base.add(0x2093CC), 'void', ['pointer', 'pointer'])(gems, movieCliperrrrrrr);

    new NativeFunction(base.add(0x2BAC08), 'void', ['pointer', 'float', 'float'])(gems, 900, 160);
    ...
    new NativeFunction(base.add(0x2BAC08), 'void', ['pointer', 'float', 'float'])(cummode, 900, 100);
