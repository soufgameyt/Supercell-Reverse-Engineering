...
function setupAntiPidor() {
	...
	const adder = Interceptor.attach(base.add(ADD_FILE), {
		onEnter: function(args) {
			...
			base.add(0x208FB8).writeByteArray([0, 0, 0, 0]); // ? ??? ?? ???? decrypt ? 0 ????????
...
toast("Brawl v36 - Improved \n Join our Telegram! t.me/ricosmoddingstudio \n \n Made by RicoDEV");